...
export async function withdrawEscrow(
  ...
  try {
    ...
    params.flatFee = true;
    params.fee = 1000 * 2; // 1000 mAlgos for sending this transaction and another 1000 mAlgos for transferring the Escrow Tokens from the contract to the sender

    console.log("__ here __");
