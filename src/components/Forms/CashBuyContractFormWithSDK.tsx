...
async function signer(unsignedTxns: Array<algosdk.Transaction>) {
  ...
  // return (window as any).algorand.signTxns(
  //   unsignedTxns.map((txn) =>
  //     (window as any).algorand.encoding.msgpackToBase64(txn.toByte())
  //   )
  // );
...
export const CashBuyContractForm = (props: P) => {
  ...
  const {
    ...
    defaultValues: {
      ...
      seller: "STRA24PIDCBJIWPSH7QEBM4WWUQU36WVGCEPAKOLZ6YK7IVLWPGL6AN6RU",
  ...
  const onSubmit = async (data: any) => {
    try {
      ...
      //     algosdk.encodeUint64(Math.floor(asaId)), // 11 GLOBAL_ASA_ID
      //     // --- --- --- --- ---
      //   ],
      //   [],
      //   [],
